...
function Home() {
  ...
  return (
    <>
      <div className=" bg-gray-400 max-w-screen-2xl mx-auto container px-6 py-3 md:px-40">
        <div className="flex h-screen items-center justify-center">
          <div className="border-2 border-dashed px-4 py-2 md:px-8 md:py-6 border-blue-400 rounded-lg shadow-lg">
            <h1 className="text-3xl font-bold text-center mb-4">
              Convert Word to PDF Free
            </h1>
            <p className="text-yellow-200 text-base text-center mb-5 ">
              Easily convert any Word documents to PDF format online
